...
public class TimelineGrid : MonoBehaviour
{
    ...
    private void CreateTimeText(float timeSeconds, float xPos)
    {
        ...
        // --- DEĞİŞİKLİK 2: Yazıyı yukarı taşıma ---
        // Metnin pivotunu (dönme/konumlanma merkezini) alt ortaya alıyoruz.
        // Sonra onu cetvelin üst kenarına sabitliyoruz.
        // Bu, metnin her zaman cetvelin üstünde kalmasını sağlar.
        textRT.anchorMin = new Vector2(0, 1);       // Alt kenarı cetvelin üstüne sabitle
        textRT.anchorMax = new Vector2(0, 1);       // Üst kenarı da cetvelin üstüne sabitle
        textRT.pivot = new Vector2(0.5f, 0);        // Pivot'u metin kutusunun ALT ORTASINA al
        textRT.anchoredPosition = new Vector2(xPos, 20f); // Üstten 20 piksel boşluk bırakarak yukarı taşı

        textRT.sizeDelta = new Vector2(100f, 20f);
