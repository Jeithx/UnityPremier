...
public class TimelineContentManager : MonoBehaviour
{
    ...
    public void AddVideoClip(string contentPath, VideoPlayer videoPrefab, GameObject barPrefab)
    {
    ...
    public void AddImage(string contentPath, GameObject barPrefab)
    {
        var trackManager = timeline.GetTrackManager();
        var config = timeline.GetConfig();
    ...
    public void AddAudio(string contentPath, GameObject barPrefab)
    {
        var trackManager = timeline.GetTrackManager();
        var config = timeline.GetConfig();
    ...
    public void AddModelToTimeline(GameObject modelPrefab, GameObject barPrefab, GameObject contextMenuPrefab, float duration = 30f)
    {
        var trackManager = timeline.GetTrackManager();
        var config = timeline.GetConfig();
