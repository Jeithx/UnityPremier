...
public class TimelineGrid : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        rulerManager.CreateTimeRuler(scrollViewContent, config);
    ...
    // Content methods
    public void addVideoClip(string contentPath) => contentManager.AddVideoClip(contentPath, VideoPrefab, barPrefab);
    public void addImage(string contentPath) => contentManager.AddImage(contentPath, barPrefab);
    public void addAudio(string contentPath) => contentManager.AddAudio(contentPath, barPrefab);
    public void addModelToTimeline(GameObject modelPrefab, float duration = 30f)
    {
        // 1. Yeni bir model için uygun kanalı ve başlangıç zamanını hesapla
        ...
        // 2. Model için 'Content' objesini oluştur
        ...
        // 3. ModelController'ı oluştur ve en önemlisi, listeye ekle
        ...
        // 4. Timeline bar'ını ve genişliğini ayarla
