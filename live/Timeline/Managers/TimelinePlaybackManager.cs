...
public class TimelinePlaybackManager : MonoBehaviour
{
    ...
    public List<EventController> eventControllers = new List<EventController>();
    ...
    public void Play()
    {
        ...
        foreach (var e in eventControllers)
            if (e != null) e.ScrubTo(now, shouldPlay: true);
    ...
    public void Stop()
    {
        ...
        foreach (var e in eventControllers)
            if (e != null) e.ScrubTo(now, shouldPlay: false);
    ...
    public void SetTime(float time)
    {
        ...
        foreach (var e in eventControllers)
            if (e != null) e.ScrubTo(time, isPlaying);
