...
public class TimelineRulerManager : MonoBehaviour
{
    ...
    public void CreateTimeRuler(RectTransform scrollViewContent, TimelineConfig config, RectTransform timeRulerParent)
    {
        ...
        timeRulerRT.gameObject.transform.transform.SetAsFirstSibling();
    ...
    private void OnRulerClick(PointerEventData eventData)
    {
        ...
        //ShowEventCreationUI(clickedTime, eventData.position);
    ...
    //private void ShowEventCreationUI(float time, Vector2 screenPosition)
    //{
    //    var eventUI = timeline.GetComponent<EventCreationUI>();
    //    if (eventUI != null)
    //    {
    //        eventUI.ShowEventCreationMenu(time, screenPosition);
    //    }
    //}
