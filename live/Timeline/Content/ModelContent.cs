...
public class ModelContent : Content
{
    ...
    //private ModelSceneManipulator _sceneManipulator;
    ...
    //private ModelTransformData _transformData;
    ...
    public override void Show()
    {
        if (_modelInstance != null)
        {
            ...
            //if (_transformData.hasCustomTransform)
            //{
            //    ApplyTransformData();
            //}
    ...
    // Scrubbing support - set animation to specific time
        ...
        float duration)
    {
        ...
        //_transformData = new ModelTransformData();

        //// Add scene manipulator component
        //_sceneManipulator = _modelInstance.AddComponent<ModelSceneManipulator>();
        //_sceneManipulator.SetAssociatedModelContent(this);

        //// Store initial transform
        //_transformData.position = _modelInstance.transform.position;
        //_transformData.scale = _modelInstance.transform.localScale;
        //_transformData.rotation = _modelInstance.transform.eulerAngles;
